...
Future<void> uploadToAppStore(String clientId) async {
  ...
  _validateDirectories(clientId, iosDir, appBundleDir);
  ...
  //  = Platform.environment['APPSTORE_API_KEY_PATH'] ?? '';
...
void _validateDirectories(String clientId, String iosDir, String appBundleDir) {
...
Future<void> _runFastlaneUpload(
    String ipaPath, String appIdentifier, String apiKeyPath) async {
...
Future<void> _buildApps(String clientId) async {
  ...
  String version = await _getVersionFromConfig(clientId);
  if (version.isEmpty) {
    return;
  }
...
Future<String> _getVersionFromConfig(String clientId) async {
